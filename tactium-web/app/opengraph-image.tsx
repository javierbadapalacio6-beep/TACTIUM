    ...
    (
      <div
        style={{
          ...
          padding: "80px",
          background:
            "radial-gradient(120% 80% at 80% 20%, rgba(0,223,130,0.18) 0%, rgba(3,15,15,0) 50%), #030F0F",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", zIndex: 1 }}>
          <svg width={56} height={56} viewBox="0 0 1254 1254" fill="none">
            <g fill="#00DF82">
          ...
          <div style={{ fontSize: "20px", fontWeight: 600, letterSpacing: "0.32em", color: "rgba(232,245,239,0.5)" }}>
            TACTIUM
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "24px", zIndex: 1 }}>
          <div style={{ fontSize: "20px", fontWeight: 500, letterSpacing: "0.28em", color: "#00DF82", textTransform: "uppercase" }}>
            iOS · Android · Web
          </div>
          <div
            style={{
          ...
          <div style={{ fontSize: "26px", fontWeight: 400, color: "rgba(232,245,239,0.7)", maxWidth: "820px", lineHeight: 1.3, display: "flex" }}>
            Alineaciones con orden de fuerza, torneos completos y la competición federada al día.
          </div>
        </div>

        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 1 }}>
          <div style={{ fontSize: "18px", fontWeight: 500, letterSpacing: "0.25em", color: "rgba(232,245,239,0.5)" }}>
