...
// + 4 detalles internos).
//
// Sincronizado con tactium-landing/components/TactiumMark.tsx. Si tocas
// uno, toca el otro.
//
// Prop `gradient`:
//   - true (default en uso actual)  → dibuja un squircle dark detrás del
//     logo para mantener masa visual a tamaños pequeños (28-44px). Mismo
//     comportamiento visual que el TactiumMark anterior.
//   - false → solo los paths del logo, fondo transparente. Usar cuando ya
//     hay un contenedor con su propio bg (cards, headers).
