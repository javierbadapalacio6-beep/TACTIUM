      ...
      >
        <div
          style={{
            ...
            maskImage:
              "radial-gradient(ellipse at center, rgba(0,0,0,1) 30%, transparent 70%)",
          }}
        />
        ...
        >
          {/* Isotipo TACTIUM oficial — vectorización fiel al PNG con fondo
              transparente. ImageResponse renderiza SVG nativamente. */}
        ...
        >
          ...
          >
            Alineaciones con auto-balance por puntos, hasta 5 variantes por
            jornada y notificaciones a tus jugadores.
          </div>
        </div>
