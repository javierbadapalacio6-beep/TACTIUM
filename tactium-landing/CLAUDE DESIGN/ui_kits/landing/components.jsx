      ...
      <div style={{
        ...
        <div className="hero-phones" style={{
          ...
          <div style={{ position: "absolute", left: "8%", top: 80, transform: "rotate(-9deg)" }}>
            <PhoneFrame src="../../assets/screens/splash.jpeg" width={250} glow floatDelay={0}/>
          </div>
          <div style={{ position: "absolute", right: 0, top: 0, transform: "rotate(6deg)" }}>
            <PhoneFrame src="../../assets/screens/alineacion.jpeg" width={300} glow floatDelay={1.4}/>
          </div>
          {/* floor reflection */}
          <div aria-hidden style={{
...
function AppPreview() {
  const steps = [
    { id: "01", title: "PROGRAMA", desc: "Crea la temporada, importa la plantilla y deja que TACTIUM ordene a los jugadores por puntos FEP.", img: "../../assets/screens/jornada-pendiente.jpeg" },
    { id: "02", title: "ALINEA",   desc: "Auto-orden por puntos en cada pareja. Variantes ilimitadas — pruebas escenarios sin tocar la oficial.", img: "../../assets/screens/alineacion.jpeg" },
    { id: "03", title: "CIERRA",   desc: "Confirmas el acta tras el partido. Resultados, sets y W.O. en un solo gesto.", img: "../../assets/screens/jornada-resultados.jpeg" },
  ];
  return (
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }} className="two-col">
        ...
        <div className="club-phones" style={{ position: "relative", height: 640, display: "flex", justifyContent: "center", alignItems: "center" }}>
          <div style={{ position: "absolute", left: "10%", top: 20, transform: "rotate(-6deg)" }}>
            <PhoneFrame src="../../assets/screens/club.jpeg" width={250} glow floatDelay={0.3}/>
          </div>
          <div style={{ position: "absolute", right: "5%", bottom: 0, transform: "rotate(7deg)" }}>
            <PhoneFrame src="../../assets/screens/equipos-club.jpeg" width={250} floatDelay={1.6}/>
          </div>
        </div>
      </div>
    </section>
