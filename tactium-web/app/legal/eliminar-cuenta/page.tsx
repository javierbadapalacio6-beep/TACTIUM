...
export default function EliminarCuentaPage() {
  return (
    <LegalPage title="Eliminar tu cuenta de TACTIUM" updated="9 de junio de 2026">
      <section>
        <p>
      ...
      <section>
        <h2>Cómo solicitarlo por correo</h2>
        <p>
          Si no puedes acceder a la app, escríbenos desde la dirección de
          correo de tu cuenta a{" "}
          <a href="mailto:hola@tactium.io">hola@tactium.io</a> con el asunto
          «Eliminar mi cuenta». Verificaremos tu identidad y procesaremos la
