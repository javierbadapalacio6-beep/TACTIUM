// Isotipo TACTIUM en SVG inline. Vectorización fiel al PNG oficial,
// fondo TRANSPARENTE (sin <rect> de fondo) para que se pueda colocar
// sobre cualquier superficie sin que el bg del logo choque con el bg
// del contenedor. Si necesitas versión con fondo, usa el PNG raster
// en /brand/logo.png o renderiza con un wrapper que tenga su propio bg.
//
// Construcción: 7 paths que componen el T monogram con velocity cuts
// (top bar + 2 wings principales + 4 detalles internos).
